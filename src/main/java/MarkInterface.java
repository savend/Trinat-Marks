            ...
            public void run() {
                ...
                EventHandler<ActionEvent> eventHandlerNameField = event -> {
                    if (mark.getClass().equals(Mark.class))
                        MarkInterface.this.updateMarkInterface(markNameField, markCoefficientField, markFField, markDField, markCHField, NAME);
                };
                ...
                EventHandler<ActionEvent> eventHandlerFField = event -> {
                    if (mark.getClass().equals(Mark.class))
                        MarkInterface.this.updateMarkInterface(markNameField, markCoefficientField, markFField, markDField, markCHField, MARK_FR);
                    else
                        MarkInterface.this.updateMarkInterface(markNameField, markCoefficientField, markFField, markDField, markCHField, NULL);
                ...
                EventHandler<ActionEvent> eventHandlerDField = event -> {
                    if (mark.getClass().equals(Mark.class))
                        MarkInterface.this.updateMarkInterface(markNameField, markCoefficientField, markFField, markDField, markCHField, MARK_DE);
                    else
                        MarkInterface.this.updateMarkInterface(markNameField, markCoefficientField, markFField, markDField, markCHField, NULL);
                };
                ...
                EventHandler<ActionEvent> eventHandlerCHField = event -> {
                    if (mark.getClass().equals(Mark.class))
                        MarkInterface.this.updateMarkInterface(markNameField, markCoefficientField, markFField, markDField, markCHField, MARK_CH);
                    else
                        MarkInterface.this.updateMarkInterface(markNameField, markCoefficientField, markFField, markDField, markCHField, NULL);
                };
                ...
                MarkInterface.this.getChildren().add(hBox);
            }
        });
    }
